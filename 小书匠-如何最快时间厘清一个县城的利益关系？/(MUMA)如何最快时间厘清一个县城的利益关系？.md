---
title: '(MUMA)如何最快时间厘清一个县城的利益关系？'
category: '/小书匠/收集/知乎问答/MUMA/f3c1d09b3a93226b266573a3830ba30b'
slug: 'https://www.zhihu.com/question/39980419/answer/2896330053'
createDate: '2023-2-16 16:49:6'
...
回答者： **<a href="https://www.zhihu.com/people/muma-53-42">MUMA</a>**
回答时间: 2023-2-16 16:49:6
点赞总数: 72436
评论总数: 803
收藏总数: 201867
喜欢总数：26462
...
![](images/33v2-ad867b82e82d0a66c57509d25210e733.jpg)
...
同样，有了这些信息，就可以和网上的工商信息平台（如 [@企查查](https://www.zhihu.com/people/0b00c2ec8387148383b636368d4b99e6) [@天眼查](https://www.zhihu.com/people/fc1e8ef4a24b7220a62f53e26c0a951e) ）登记的信息进行对比，看当地招商局的说法和网上工商登记的信息是否有较大的出入。比如当地招商局说某企业有几亿的年产值，但网上查询到的登记社保参保人数只有二三十个，则说明当地的执法强度很低，利益关系很可能比较复杂。又比如工商信息查询平台提示该企业有大量重大经营风险，特别是存在大量败诉后未执行的案件，则该县的利益很有可能高度复杂——一地存在大量高风险企业不少见，但高风险企业能在当地不断壮大且获得当地招商局推荐，就很值得玩味了。
...
相关招商局（投资促进局）的拓展阅读，可以参考下面答主写的一个几万字的回答：

[投资促进局和商务局哪个好？](https://www.zhihu.com/answer/2403261324)
...
最近答主因为回答昆山这个中国最强县级市是否适合长期工作和生活的问题，运用了本回答中第一大点的分析方式，现将其补充到本回答之后，有兴趣的读者可以作为实操案例来阅读，当然对于答主认为昆山不适合长期工作和生活的结论，请自行甄别判断。

[昆山这个城市怎么样？适合长期生活和工作吗？](https://www.zhihu.com/question/61297847/answer/3333004082)

不适合。

答主没有去过昆山，只是因写一个回答去昆山政府网站浏览了部分信息得出此结论，回答见下。

[求问 县级市教育局副局长在当地是什么水平?](https://www.zhihu.com/question/634634748/answer/3332230993)

首先，答主访问昆山市政府的网站，浏览器给出的提示是该网站不安全不建议答主访问，见下图

![](images/34v2-5529842156263593997a4e7e4dd33eb0.jpg)

答主点开了对应的警告提示信息，原因是昆山市政府网站的安全证书过期一百多天，即https：//模式下访问该网站无法获得可信的安全证书，答主只能强行放弃浏览器的安全证书核验才能继续访问。

之后答主在主页以“预算”为关键字搜索，弹出的网页根本就没有搜索结果展示……

想搜索出结果，必须点首页上的“信息公开”子栏目，从其弹出的另一个搜索框中才能进行文件搜索，见下图

![](images/35v2-b86c57e19b649b39ea96ee4468a08603.jpg)

而上图的槽点也不少，比如说标题查询栏和索引号查询栏竟然没有对齐，又比如说检索出来的文件最早也是2018年1月，之后的预算文件就检索不到了。而在另一个子栏目下的检索框，依据“预算”为关键字搜索出来的又是另一个样子，见下图

![](images/36v2-b055767dfc3e333c20634cd99921c70d.jpg)

检索出来的结果比前一个入口略好一点，虽然还是没有最近两年的，但好歹更新到了2020年3月，但内容还是很值得吐槽，其审计局2018年的公告，发布时间是2020年3月。

而答主想查找的2023年昆山市教育局财政预算文件，在教育局的网页里完全没有结果，见下图

![](images/37v2-8cf4333eeea15828e81d001f2ec88f33.jpg)

那从首页的数据开放栏目进去搜索呢？

![](images/38v2-cba1c9f409dd04f5c594fc5458df4c03.jpg)

很遗憾，检索只支持单个关键字，不能用“教育局+预算”检索，而单独用“预算”来检索，反馈的结果大概率不是你想要的，而且还标注了有条件开放，即你先要注册会员，然后才能提交申请，最后申请被通过时才能下载这个文件。而其他地市的网站，这些内容基本都是可以随意检索并随意下载的。

故最后在找遍了整个昆山市政府的网站都没有找到想要内容的情况下，答主只能在其他网站找到了这个文件，打开后如下图。

![](images/39v2-2f97cb08579833f106ba7184fabaf1f6.jpg)

让人吐槽的是，昆山市教育局2023年度公开的单位预算中，有很大篇幅给了某个局领导的讲话稿，在讲话稿里该领导还讲了本地某个校长写了一本书，教育局一把手给书写了序言，该领导对一把手写的序言还进行了赞扬……

答主顺手查了一下震川小学网站的学校概况，画风是这样的

![](images/40v2-300bf0dc5f2cdcb601678fc3cc476872.jpg)

上某购物平台顺带查了讲话稿提及的《文化立校的行与思》，原书定价58块，按销量排序如下

![](images/41v2-b7c4701974481ac92953de6947964655.jpg)

而之后的预算内容，也是槽点满满，比如说教育局的年度预算支出为2亿元，见下图。

![](images/42v2-131461dc04569de96b7e1bd9d1429f67.jpg)

在答主看来，这个数字明显偏少，于是答主又看了下去，后面的解释如下

![](images/43v2-fba0144e88fd0bba4bcc78e8df2eba6d.jpg)

从说明上看，2022年昆山市教育局的预算是9.3亿。教育局的年度预算非常神奇的在一年内砍了80%……为了验证是不是数据错了，答主又找了前几年的预算。从2017年的文件来看，似乎昆山教育局有这种大砍又大涨预算玩过山车的传统，2017年预算是11.7亿，比2016年的7.7亿增加了4亿，涨幅为52.4%，见下图。

![](images/44v2-744750d8bc98eba9c44552b3ecb79e50.jpg)

对于这种基本民生预算年度之间大幅波动的情况，答主完全不能理解，于是转而对比昆山市一级的教育支出情况，2023年和2022年都是28亿左右，见下图。

![](images/45v2-2d9d6156843c34f56da112c8fdf445b9.jpg)

2023年预算为27.6亿，这个数字相较于昆山市32万学生的总量来说偏低。

![](images/46v2-0edbc69a8f53b3659a7db3bbf908e499.jpg)

2022年预算数为28.1亿，仅比下一年多0.5亿，这和市教育局的预算在2022年比2023年多7亿相比差别很大，答主完全不能理解市教育局23年预算从9亿砍到2亿，其中的6.5亿去哪里了。

综上，从答主的视角来看，假如答主是一个准备到昆山生活并投资做一些教育产业的小老板，想先期到昆山市政府的网站上做一些摸底情况了解，那么得到的将是槽点满满的体验。

首先，昆山市的网上政务服务对答主来说将完全不可用——昆山市政府网站的安全证书过期，这导致答主会疑虑自己先期在当地办理企业工商登记以及教育产业资质审批的所有信息都有可能因为通过不安全的网络链接而泄露甚至被盗用。

其次，昆山市政府网站首页的信息检索功能就是一个摆设，完全无法搜索出任何信息，答主怀疑其只是一个装饰挂件，完全没有链接到后台的信息数据库，只有当访问者点开首页上诸如“信息公开”或“数据开放”这两个栏目时，其出现的搜索框才链接到后台的数据库接口。

第三，数据搜索功能很烂，先不说两个搜索框都没有对齐。其即不能实现模糊搜索，即一个搜索框可以同时输入标题、文号、索引号、发文机构等关键字检索而不用分多个专门对应的搜索框输入；同时也不能实现多关键字同时搜索，比如不支持“教育局+预算”这两个关键字同时搜索。

